...
import {Animated, ColorValue, Easing, Platform, StyleProp, StyleSheet, View, ViewStyle} from 'react-native';
...
const MaterialIndicator = ({
  ...
  const size =
    typeof indicatorSize === 'string' ? (indicatorSize === 'small' ? 24 : 48) : indicatorSize ? indicatorSize : 24;
